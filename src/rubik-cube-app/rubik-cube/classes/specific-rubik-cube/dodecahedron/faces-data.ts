...
import type { TDodecahedronFaces } from '@/rubik-cube-app/rubik-cube/types/specific-rubik-cube/dodecahedron';

export class RubikDodecahedronFacesData implements IRubikCubeFacesData<TDodecahedronFaces> {
  public readonly facesPiecesIdxs: Record<TDodecahedronFaces, Array<TPieceIdx>> = {
