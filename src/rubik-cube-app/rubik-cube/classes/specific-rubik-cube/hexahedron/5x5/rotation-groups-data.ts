...
export class RubikHexahedron5x5RotationGroupsData
  implements IRubikCubeRotationGroupsData<THexahedron5x5RotationGroups>
{
  public readonly rotationGroupsPiecesIdxs: Record<THexahedron5x5RotationGroups, Array<TPieceIdx>> =
    {
      Front: [
      ...
      Back: [
        4, 3, 2, 1, 0, 29, 28, 27, 26, 25, 45, 44, 43, 42, 41, 61, 60, 59, 58, 57, 77, 76, 75, 74,
        73,
      ],
      Right: [
        24, 19, 14, 9, 4, 40, 35, 33, 31, 29, 56, 51, 49, 47, 45, 72, 67, 65, 63, 61, 97, 92, 87,
        82, 77,
      ],
      Left: [
        0, 5, 10, 15, 20, 25, 30, 32, 34, 36, 41, 46, 48, 50, 52, 57, 62, 64, 66, 68, 73, 78, 83,
        88, 93,
      ],
      Up: [
      ...
      SliceX: [2, 7, 12, 17, 22, 27, 38, 43, 54, 59, 70, 75, 80, 85, 90, 95],
      SliceY: [52, 53, 54, 55, 56, 50, 51, 48, 49, 46, 47, 41, 42, 43, 44, 45],
