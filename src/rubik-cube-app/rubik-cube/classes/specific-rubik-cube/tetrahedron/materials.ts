  ...
  implements IRubikCubeMaterials<TTetrahedronFaces, TTetrahedronEdgeFaces>
{
  private readonly _cubeFacesMaterials: typeof this.cubeFacesMaterials = {
    Front: { material: new MeshBasicMaterial({ color: 0x0000ff }), color: 0 },
    Right: { material: new MeshBasicMaterial({ color: 0xff0000 }), color: 1 },
    Left: { material: new MeshBasicMaterial({ color: 0x00ff00 }), color: 2 },
    Down: { material: new MeshBasicMaterial({ color: 0xffff00 }), color: 3 },
  };
  ...
  public get cubeEdgeFacesMaterials(): Record<TTetrahedronEdgeFaces, MeshBasicMaterial> {
    return this._cubeEdgeFacesMaterials;
  }
  public get cubeInvisibleFacesMaterials(): MeshBasicMaterial {
